...
(function (Movie_Tutorial) {
    ...
    })(Administration = Movie_Tutorial.Administration || (Movie_Tutorial.Administration = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var Administration;
    (function (Administration) {
...
(function (Movie_Tutorial) {
    ...
    })(BasicSamples = Movie_Tutorial.BasicSamples || (Movie_Tutorial.BasicSamples = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Movie_Tutorial.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Movie_Tutorial.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Movie_Tutorial.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Movie_Tutorial) {
    ...
    })(Common = Movie_Tutorial.Common || (Movie_Tutorial.Common = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var Common;
...
(function (Movie_Tutorial) {
    ...
    })(Membership = Movie_Tutorial.Membership || (Movie_Tutorial.Membership = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var Membership;
...
(function (Movie_Tutorial) {
    ...
    })(Northwind = Movie_Tutorial.Northwind || (Movie_Tutorial.Northwind = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var Northwind;
...
(function (Movie_Tutorial) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Movie_Tutorial.Northwind.Gender', 'Movie_Tutorial.Northwind.Entities.Gender');
    })(Northwind = Movie_Tutorial.Northwind || (Movie_Tutorial.Northwind = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
...
(function (Movie_Tutorial) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Movie_Tutorial.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Movie_Tutorial.LanguageList || (Movie_Tutorial.LanguageList = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
...
(function (Movie_Tutorial) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('Movie_Tutorial');
        Serenity.EntityDialog.defaultLanguageList = Movie_Tutorial.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = Movie_Tutorial.ScriptInitialization || (Movie_Tutorial.ScriptInitialization = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var Administration;
...
(function (Movie_Tutorial) {
    ...
    Movie_Tutorial.BasicProgressDialog = BasicProgressDialog;
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Movie_Tutorial.BasicProgressDialog();
...
(function (Movie_Tutorial) {
    ...
    })(DialogUtils = Movie_Tutorial.DialogUtils || (Movie_Tutorial.DialogUtils = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var Common;
...
(function (Movie_Tutorial) {
    ...
    Movie_Tutorial.StaticTextBlock = StaticTextBlock;
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Movie_Tutorial.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(Movie_Tutorial.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(Movie_Tutorial.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Movie_Tutorial.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Movie_Tutorial.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Movie_Tutorial.Authorization.userDefinition.DisplayName,
...
(function (Movie_Tutorial) {
    ...
    (function (Northwind) {
        ...
        }(Movie_Tutorial.Common.GridEditorDialog));
...
(function (Movie_Tutorial) {
    ...
    (function (Northwind) {
        ...
        }(Movie_Tutorial.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return Movie_Tutorial.LanguageList.getValue();
            };
...
(function (Movie_Tutorial) {
    ...
    })(Authorization = Movie_Tutorial.Authorization || (Movie_Tutorial.Authorization = {}));
})(Movie_Tutorial || (Movie_Tutorial = {}));
var Movie_Tutorial;
(function (Movie_Tutorial) {
    var BasicSamples;
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(Movie_Tutorial.Northwind.ProductDialog));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(Movie_Tutorial.Northwind.ProductGrid));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Movie_Tutorial.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Movie_Tutorial.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Movie_Tutorial.Northwind.OrderDialog();
                        ...
                        var chai = Movie_Tutorial.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Movie_Tutorial.Northwind.EmployeeRow.getLookup().items
        ...
        }(Movie_Tutorial.Northwind.OrderGrid));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(Movie_Tutorial.Northwind.OrderDialog));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Movie_Tutorial.Northwind.CategoryService.Retrieve({
        ...
        }(Movie_Tutorial.Northwind.CategoryDialog));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(Movie_Tutorial.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Movie_Tutorial.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Movie_Tutorial.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Movie_Tutorial.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Movie_Tutorial.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Movie_Tutorial.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Movie_Tutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Movie_Tutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Movie_Tutorial.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Movie_Tutorial.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Movie_Tutorial.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Movie_Tutorial.Northwind.OrderService.baseUrl; };
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(Movie_Tutorial.Northwind.SupplierDialog));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Movie_Tutorial.Northwind.SupplierGrid));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Movie_Tutorial.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Movie_Tutorial.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Movie_Tutorial.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Movie_Tutorial.Northwind.OrderService.baseUrl; };
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Movie_Tutorial.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Movie_Tutorial.Northwind.CustomerDialog));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(Movie_Tutorial.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Movie_Tutorial.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Movie_Tutorial.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Movie_Tutorial.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Movie_Tutorial.Northwind.OrderDetailDialog));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(Movie_Tutorial.Northwind.OrderDetailsEditor));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Movie_Tutorial.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Movie_Tutorial.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Movie_Tutorial.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Movie_Tutorial.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(Movie_Tutorial.Common.BulkServiceAction));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Movie_Tutorial.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Movie_Tutorial.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Movie_Tutorial.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Movie_Tutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Movie_Tutorial.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Movie_Tutorial.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Movie_Tutorial.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Movie_Tutorial) {
    ...
    Movie_Tutorial.SelectableEntityGrid = SelectableEntityGrid;
})(Movie_Tutorial || (Movie_Tutorial = {}));
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Movie_Tutorial.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Movie_Tutorial.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Movie_Tutorial.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Movie_Tutorial.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Movie_Tutorial.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Movie_Tutorial.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Movie_Tutorial.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Movie_Tutorial.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Movie_Tutorial.Northwind.ProductService.baseUrl; };
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Movie_Tutorial.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Movie_Tutorial.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Movie_Tutorial.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Movie_Tutorial.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Movie_Tutorial) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Movie_Tutorial.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Movie_Tutorial.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Movie_Tutorial.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=Movie_Tutorial.Web.js.map